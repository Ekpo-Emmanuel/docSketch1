...
export default function Features() {
  ...
  return (
    <>
      <section>
        <div
          className="px-8  mx-auto md:px-12 max-w-7xl"
          id="features"
        >
          <div>
            ...
            <p className="mt-4 text-base font-medium text-gray-500 text-balance">
              Docsketch goes beyond traditional document editing. Here's how it
              empowers your collaborative process:
            </p>
            <div className="grid grid-cols-2 mt-12 gap-x-6 gap-y-12 lg:mt-16 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16 text-balance">
              ...
              <div className="flex flex-col gap-4 lg:flex-row">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Format text with features like headings, lists, and quotes
                    and more.
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-4 lg:flex-row">
                ...
                <div>
                  <h3 className="font-medium text-gray-900"> Team projects</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    Work with teams on a project simultaneously
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-4 lg:flex-row">
